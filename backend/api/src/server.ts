...
import { startCampaignSchedulerWorker } from './modules/agents/campaign-scheduler.worker.js';
...
const campaignSchedulerWorker = startCampaignSchedulerWorker(config, database.db);
